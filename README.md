...
* Clone this repository: `git clone "https://github.com/Ahortu901/AirBnB_clone.git"`
* Access AirBnb directory: `cd AirBnB_clone`
* Run hbnb(interactively): `./console` and enter command
* Run hbnb(non-interactively): `echo "<command>" | ./console.py`

## File Descriptions :house:
...
#### `models/` directory contains classes used for this project :cl:
...
#### `/models/engine` directory contains File Storage class that handles JASON serialization and deserialization :baggage_claim:
...
#### `/tests` directory contains all unit test cases for this project :straight_ruler:
